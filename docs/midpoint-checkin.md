> 📍 [← Back to the main README](../README.md) &nbsp;·&nbsp; 📄 Official report: [`AISE_MidSubmission.docx`](AISE_MidSubmission.docx)
>
> **Note:** this document describes the **spectral-index** variant of the pipeline
> (NDWI / MNDWI / NDVI + SAR log-ratio, Prithvi EO v2 300M, Optuna HPO, 3-seed ensemble).
> The stack shipped in [`notebooks/`](../notebooks/) is the **terrain-informed** variant
> (SWIR + DEM + Fast-HAND + Slope). See *"An alternative feature stack we explored"* in the
> main README for a side-by-side comparison.
